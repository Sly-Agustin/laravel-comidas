...
<main class="py-4 fontRoboto">
    <div class="container">
        ...
        <div class="container containerBg rounded p-2">
            <p>Ingredientes: Obligatorio, para agregar ingredientes pulse el botón "agregar", seleccionar de la lista un ingrediente y especificar las cantidades en la unidad correspondiente (ml, cucharadas, gr, etc).</p>
        ...
        @endif
            ...
            <div id="divIngredientes">
                ...
                <input type="button" class="normalButton rounded" value="Agregar" id="botonIngredientes" onclick="crearIngrediente({{$ingredientes}})">
            </div>
