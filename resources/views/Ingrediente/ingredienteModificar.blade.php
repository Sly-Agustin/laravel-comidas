            ...
            <form action="{{route('ingrediente.update', $ingrediente->id_ingrediente)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea type="text" name="descripcionIngrediente" class="form-control" id="inputDescripcion">{{$ingrediente->descripcion}}</textarea>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Tipo</label>
                        <select class="form-control" name="tipoIngrediente" id="ingredienteTipo">
                            <option value="{{$ingrediente->tipo}}">Seleccione una opción, tipo actual: {{$ingrediente->tipo}}</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="ubicacionIngrediente" class="form-control" id="inputUbicacion" value="{{ $ingrediente->ubicacion }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Caracteristicas</label>
                        <input type="text" name="caracteristicasIngrediente" class="form-control" id="inputCaracteristica" value="{{ $ingrediente->caracteristicas }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Es visible al resto de los usuario? (Es decir está baneado o no)</label>
                        <!--Esto es muy sucio pero es un fix rápido, limpiar después-->
                        @if ($ingrediente->isVisible)
